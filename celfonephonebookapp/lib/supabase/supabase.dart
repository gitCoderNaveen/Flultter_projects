...
class SupabaseService {
  ...
  static Future<void> init() async {
    await Supabase.initialize(
      url: "https://nryjcdhvqsywptlwdymx.supabase.co",   // Replace with your Supabase URL
      anonKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5yeWpjZGh2cXN5d3B0bHdkeW14Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTUxMDYwNDQsImV4cCI6MjA3MDY4MjA0NH0.nK2ebd_tZcx3XJ_6HnHF-EBbbB3PyHTix7oYa-KIwKo",           // Replace with your Anon Key
    );
  }
