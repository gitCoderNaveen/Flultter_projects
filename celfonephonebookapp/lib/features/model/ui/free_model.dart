...
class FreeModel extends StatefulWidget {
  final String profileId;

  const FreeModel({super.key, required this.profileId});

  @override
  State<FreeModel> createState() => _FreeModelState();
}

class _FreeModelState extends State<FreeModel> {
      ...
      body: Column(
        children: [
          ...
          FutureBuilder<List<String>>(
            future: SupabaseService().fetchHeaderImages(),
